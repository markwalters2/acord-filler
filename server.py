...
Only include coverages that are actually present. Set "has": false for coverages not found. Use empty strings for fields not found. Return compact minified JSON."""
